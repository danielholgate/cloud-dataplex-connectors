...
1. Create a user in the Oracle instance(s) which will be used by Dataplex to connect and extract metadata about tables and views. This user requires the following Oracle privileges and roles: 
...
## Run an end-to-end meatdata extraction and import process from Oracle into Dataplex
