...
# Set variables
PROJECT_ID="daniel-dataplex"  # Replace with your Google Cloud project ID
SERVICE_ACCOUNT_EMAIL="440165342669-compute@developer.gserviceaccount.com" # Replace with your service account email
